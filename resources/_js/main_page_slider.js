$(document).ready(function(){
	...
	$('.main-page_promo-line_slider-element:last').prependTo('.main-page_promo-line_slider-block');
	...
	var images = $('.main-page_promo-line_slider-element');
	...
	var interval_id = setInterval(change_img, 7000);

	function change_img() {
		// отработка смены изображений в слайдере
		$('.main-page_promo-line_slider-block').animate({left: -(slide_width*2)}, 1500, function(){
			$('.main-page_promo-line_slider-block > .main-page_promo-line_slider-element:first').appendTo('.main-page_promo-line_slider-block');
		});
...
/*------------------------------------------------------------------*/
	...
	line.on('click', function(){
		...
		$.each(arr, function(s, num_line){
			image_block_clone.find('.main-page_promo-line_slider-element[data-pic="' + num_line + '"]').appendTo(image_block);
		});
		...
		// собираем все изображения
		images = $('.main-page_promo-line_slider-element');
		...
		interval_id = setInterval(change_img, 7000);
	});
...
console.log('вправо!');
				...
				$('.main-page_promo-line_slider-block').animate({left: 0}, 500, function(){
					$('.main-page_promo-line_slider-block > .main-page_promo-line_slider-element:last').prependTo('.main-page_promo-line_slider-block');
				});
				$('.main-page_promo-line_slider-block').animate({left: -slide_width}, 0);
