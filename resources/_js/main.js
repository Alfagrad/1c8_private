...
//ITEM-TABLE-USD-TOGGLER
    ...
    //         $('.filter_in-stock').removeClass('_active');
    //         $('.filter_soon').removeClass('_active');
    //         $('.filter_reserve').removeClass('_active');
    //     }
    //     return false;
    // });
...
/*-------------------------------------------------------------------------*/
    ...
    * */
    ...
    //             $(this).hide();
    //             $('.spare-analog_line').css('display', 'none'); // чтобы не высвечивали аналоги
    //             console.log('АН-1');
    //         } else {
    //             $(this).show();
    //             $('.spare-analog_line').css('display', 'none'); // чтобы не высвечивали аналоги
    //             // если фильтр Архив выключен, прячем блоки с архивом
    //             if(!$('.filter_archive').hasClass('_active')) {
    //                 $('#js-archive-items').css('display', 'none');
    //             }
    //             console.log('АН-2');
    //         }
    //     });
