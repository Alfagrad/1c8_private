                        ...
                        <div class="header_phones _js-phones-block">
                            ...
                            @if($manager ?? false)
                                ...
                                @if($manager->viber)
                                    ...
                                    <div class="header_phone-element">
                                        <div class="header_phone-line menager">
                                            <img src="{{ asset('assets/img/viber_ico_3.png') }}"
                                                 class="header_phone-ico">
                                ...
                                @if($manager->skype)
                                    ...
                                    <div class="header_phone-element">
                                        <div class="header_phone-line menager">
                                            <img src="{{ asset('assets/img/skype_ico_3.png') }}"
                                                 class="header_phone-ico">
                ...
                <div class="">
                    ...
                    <div class="header_info-lines header_search-block">
                        <div class="header_search-line">
                            ...
                            <button type="submit" class="header_search-submit-button js-redirect-search"
                                    data-is_service=0 title="Искать">
                ...
                <div class="">
                    <div class="header_user-avatar js-mobile-ico flex space-x-2 items-center">
                        ...
                        <div class="header_user-name">
                            <a
                                ...
                                title="В кабинет - {{ profile()->company_name }}"
                            >
                                {{ profile()->name }}
                            </a>
                        </div>
                    ...
                    <div class="header_user-cabinet-links">
                        <ul class="header_user-menu">
                            @yield('order-history')
                            <li><a href="{{ route('profile.index') }}" title="В кабинет - Настройки">Настройки</a></li>
