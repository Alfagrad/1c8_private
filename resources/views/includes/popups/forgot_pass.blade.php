<div x-data="{show:false}" x-show="show" x-cloak x-transition x-on:forgot-password.window="show=true" class="open_popup _js-popup-forgot-pass">

    <div class="open_popup_wrapper">

        <div class="open_popup_info-block">

            <div @click="show=false" class="open_popup_close-button _js-forgot-close">×</div>
            ...
            <div class="open_popup_form-wrapper">
                ...
                <form class="open_popup_form" id="form-remember-password" method="post"
                      action="{{route('remember.restore')}}">
