...
{{--    <link rel="stylesheet" href="{{ asset('assets/css/styles.css').'?v='.config('constants.version') }}">--}}
    @vite(['resources/scss/private.scss'])
...
@if(profile()->isDealer())
    @include('includes.headers.dealer')
@else
    @include('includes.headers.service')
@endif
...
@vite(['resources/js/app.js', 'resources/js/home_page_resizer.js', 'resources/js/home_page_right_block_handler.js', 'resources/js/search_handler.js'])
