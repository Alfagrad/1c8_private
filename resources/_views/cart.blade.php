...
@endphp
    ...
    <div class="b-wrapper p-cart">
        @include('general.header')
        @include('general.nav')
        @include('general.bcrumb')
        <section class="s-main-wrapper">
            <div class="container">
                <div class="wrapper update_content">
                                                        ...
                                                        <div class="w-dropper w-dropper-width-300 w-dropper-cart">
                                                            <div class="w-dropper-hovered w-dropper-cart cart-select">
                                                                <div class="name" style="font-size: 14px;">
                                                                    Переместить/копировать в корзину ...
                                                                </div>
                                                                ...
                                                                @foreach($cartArrayForSelect as $key => $value)
                                                                    @if($key != $cartId)
                                                                        ...
                                                                        <div class="button" style="text-align:left;"><a
                                                                                    ...
                                                                                    class=" change-position"
                                                                                    data-action="2"
                                                                                    data-idcart="{{$key}}">Скопировать
                                                                                в {{$value}}</a>
                                                                        </div>
                                                                    @endif
                                                                @endforeach

                                                                <div class="button"><a class=" delete-position"
                                                                                       href="/cart/{{$key}}">Удалить
                                                                ...
                                                                @if($cartId != 0 && $cartId != null)
                                                                    ...
                                                                    <div class="button" style="text-align:left;">
                                                                        <a href="#" class=" change-position-with-main"
                                                                           data-action="2" data-idcart="{{$cartId}}">
...
@include('catalog.snippets.item_block_line')
                            ...
                            {{-- удаляем, чтобы срабатывало "Акционные товары" --}}
                            @php unset($buyForget); @endphp
...
@include('catalog.snippets.item_block_line')
                            ...
                            {{-- удаляем, чтобы срабатывало "Ранее куплено" --}}
                            @php unset($actions); @endphp
                                ...
                                <div class="w-table">
                                    <div class="table-head dropdown">
                                        <table>
                                            ...
                                            <tr>
                                                <td class="td-image">
                                                    @if($itemsFromOrder->count() > 4)
                                                    <div 
                                                        data-category="beforeBuy"
                                                        title="Показать/скрыть все товары"
                                                        class=" toggler-buttonfor-cart"
                                                        id="beforeBuy" 
                                                    >
                                                    ...
                                                    <span 
                                                        ...
                                                        title="Показать/скрыть все товары"
                                                    >
                                                        Показать все ({{ $itemsFromOrder->count() }})
                                                    </span>
                                                    @endif
                                                </td>
                                                <td class="td-article"></td>
...
@include('catalog.snippets.item_block_line')
                            ...
                            {{-- удаляем, чтобы срабатывало "С этим товаром покупают" --}}
                            @php unset($itemsFromOrder); @endphp

                        </div>

                        <div class="wrapper clap-content items-table catalog-table fade"
                             style="padding: 0px; background-color:transparent;">
