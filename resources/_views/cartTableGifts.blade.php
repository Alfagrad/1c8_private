                    ...
                    <div class="table-body">
                        <table>
                            ...
                            @foreach($gifts as $item)
                                <tr class="tr_gift" data-tr_gift_id="{{ $item->{'1c_id'} }}">
                                    ...
                                    <td class="td-price">
                                        ...
                                        @if($item->discounted != 0)
                                            <div class="content-show-old-price">   {{ number_format(($item->bel_price / ( (100 - $item->discounted) / 100)), 2, '.',' ')  }}</div>
                                        @endif
                                    </td>
