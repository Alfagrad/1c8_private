    ...
    <div class="container">
        ...
        <div class="catalog-page_catalog-lines-section">
            ...
            <div class="catalog-page_catalog-lines-block">
                ...
                <div class="catalog-page_catalog-lines-title">

                    @php
                        if($search_type == 'spares') {
                            $type = "Запчасти";
                            $link_search_type = "products";
                            $link_type = "Товары";
                        } else {
                            $type = "Товары";
                            $link_search_type = "spares";
                            $link_type = "Запчасти";
                        }
                    @endphp
                    ...
                    @if($search_result->count())
                        ...
                        <div>
                            Результат поиска <strong>&laquo;{{ $search_words }}&raquo;</strong> в разделе <strong>&laquo;{{ $type }}&raquo;</strong>
                        </div>

                    @else

                        <div>
                            По запросу <strong>&laquo;{{ $search_words }}&raquo;</strong> в разделе <strong>&laquo;{{ $type }}&raquo;</strong> ничего не найдено!
                        </div>
                        <div>
                            Попробуйте поиск в разделе
                            <a href="{{ asset('catalogue/search?type='.$link_search_type.'&search_keywords='.$search_words) }}">
                                {{ $link_type }}
                            </a>
                        </div>
                ...
                @foreach($search_result as $cat)
                    ...
                    <div class="items-line-block js-lines-block js-index-{{ $cat_index }} {{ $archive_cat_class }}">
