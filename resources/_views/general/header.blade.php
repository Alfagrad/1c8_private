                ...
                <div class="h-customer">
                    <div class="wrapper w-customer-info">
                        ...
                        <ul class="customer-config-menu">
                            <li><a href="{{route('profileOrders')}}">История заказов</a></li>
                    ...
                    <div class="w-contacts">
                        <div class="w-dropper">
                            <div class="w-dropper-hovered">
                                <div class="phones">
                                    <div class="tel _phone"><a href="tel:<?php echo '+'. preg_replace("/\D/", "", setting('header_city_phone_1') );?>">{!!  setting('header_city_phone_1') !!}</a></div>
                                    <div class="tel _vel"><a href="tel:<?php echo '+'. preg_replace("/\D/", "", setting('header_vel_phone_1') );?>">{!! setting('header_vel_phone_1') !!}</a></div>
                                    <div class="tel _mts"><a href="tel:<?php echo '+'. preg_replace("/\D/", "", setting('header_mts_phone_1') );?>">{!! setting('header_mts_phone_1') !!}</a></div>
                                    <div class="tel _life"><a href="tel:<?php echo '+'. preg_replace("/\D/", "", setting('header_life_phone_1') );?>">{!! setting('header_life_phone_1') !!}</a></div>
                                </div>
