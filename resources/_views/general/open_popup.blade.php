<div class="open_popup js-popup">
    
    <div class="open_popup_wrapper">
        
        <div class="open_popup_info-block">

            <div class="open_popup_close-button js-popup-close">×</div>
            ...
            <div class="open_popup_form-wrapper">
                ...
                <form class="open_popup_form" id="captcha-validate" method="post" action="{{ asset('/mail-to-us') }}">
