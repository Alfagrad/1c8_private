        ...
        <div class="main-navigation_links-block">
            ...
            <ul class="main-navigation_category-links" id="_js-links-block">
                ...
                <li class="main-navigation_catalog-link">
                    <a href="{{ asset('/catalogue') }}" class="main-navigation_catalogue-button _js-catalog-button" title="Каталог продукции">
                        Каталог
                    ...
                    @if($m->link)
                        ...
                        @else
                            ...
                            >
                                ...
                                <ul x-show="show" class="main-navigation_sub-category-links _js-sub-links">
