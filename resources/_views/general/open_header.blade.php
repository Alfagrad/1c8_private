<div class="open_header">
    ...
    <div class="open_main-page_header_logo-line">
        <div class="container">
            <a href="{{ asset('/') }}" class="open_main-page_header_logo">
...
{{--
 ...
 --}}
                ...
                <div class="open_main-page_header_brand-sites-block" id="js-sites-block">
                    ...
                    <div x-data="{show: false}" @mouseover="show=true" @mouseleave="show=false" class="open_main-page_header_brand-site-links">
                        ...
                        <div x-show="show" class="open_main-page_header_site-link">
...
{{--                 <div class="open_main-page_header_languiges-block" id="js-lang-block">
                ...
                <a href="{{ asset('/home') }}" class="open_main-page_header_dealer-enter js-dealer-enter" title="Вход / Регистрация дилера">
                    <div class="open_main-page_header_svg">
                        @include('svg.enter_ico')
                    </div>
                    <div class="open_main-page_header_dealer-text">
                        Вход / Регистрация
                    </div>
                </a>
            ...
            <div class="open_header_main-menu-block">
                ...
                <nav class="open_header_main-menu" id="js-main-menu">
                    ...
                    <ul >
                        ...
                        <li>
                            <a href="{{ route('dealer.open') }}"
                               @if(Route::currentRouteName() == 'dealer.open') class="active" @endif
                            >
                                Дилерам
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('brand.open') }}"
                               @if(Route::currentRouteName() == 'brand.open') class="active" @endif
                            >
                                Бренды
                            </a>
                        </li>
                        <li class="service-menu">
                            ...
                            <ul class="service-sub-menu">
                                <li>
                                    <a href="{{ route('service.open') }}" class="@if(Route::currentRouteName() == 'service.open'){{ "active"}}@endif">
                                        Адреса Сервисных Центров
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('service.documents') }}" class="@if(Route::currentRouteName() == 'service.documents'){{ "active"}}@endif">
                                        Ремонты, брак, документы СЦ
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('erip.open') }}" class="@if(Route::currentRouteName() == 'erip.open'){{ "active"}}@endif">
                                        Оплата через ЕРИП
                                    </a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a
                                href="{{ route('vacancy.open') }}"
                                @if(Route::currentRouteName() == 'vacancy.open') class="active" @endif
                            >
                                Вакансии
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('contact.open') }}"
                               @if(Route::currentRouteName() == 'contact.open') class="active" @endif
                            >
                                Контакты
                            </a>
                        </li>
