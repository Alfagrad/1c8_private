                            ...
                            <div class="wrapper white-bg-wrapper">
                                ...
                                <form class="wrapper b-cabinet-content" id="form-profile" method="post" action="/profile/update" enctype="multipart/form-data">
                                    ...
                                    <div class="wrapper w-main-info">
                                        <div class="section-name" style="text-align: center;">Основная информация</div>
                                        <div class="left" style="width: inherit;">
                                            <div class="row">
                                    ...
                                    <div class="wrapper w-contacts-info" style="display: flex;">
                                        <div class="left" style="width: 49%; padding: 10px;">
                                        ...
                                        <div class="right" style="width: 49%; padding: 10px; border-left: none;">
