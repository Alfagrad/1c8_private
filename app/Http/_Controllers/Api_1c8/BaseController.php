...
class BaseController extends Controller
{
    ...
    static public function allCommonDiscountStrings()
    {
        ...
        if (count($common_discount_uuids)) {
            ...
            $product_uuids = DiscountProduct::whereIn('discount_uuid', $common_discount_uuids)->pluck('product_uuid')->toArray();
    ...
    static public function getCommonDiscounts($item_uuid)
    {
        ...
        $item_discount_uuids = DiscountProduct::where('product_uuid', $item_uuid)->pluck('discount_uuid')->toArray();
        ...
        if (count($item_discount_uuids)) {
            ...
            if ($item) {
                ...
                foreach ($item_discounts as $value) {
                    ...
                    $item_dates = DiscountProduct::where([['discount_uuid', $value->discount_uuid], ['product_uuid', $item_uuid]])->first(['date_start', 'date_end']);
