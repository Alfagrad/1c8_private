...
Route::get('/', \App\Http\Controllers\Open\Index::class)->name('open.index');
Route::get('/for-dealers', \App\Http\Controllers\Open\Dealer::class)->name('open.dealer');
Route::get('/brands', \App\Http\Controllers\Open\Brands::class)->name('open.brand');
Route::get('/services', [\App\Http\Controllers\Open\ServiceController::class, 'index'])->name('open.service');
Route::get('/service-documents', [\App\Http\Controllers\Open\ServiceController::class, 'serviceDocs'])->name('open.service.documents');
Route::get('/erip-pay', [\App\Http\Controllers\Open\ServiceController::class, 'eripPay'])->name('open.erip');
Route::get('/repair-status', [\App\Http\Controllers\Open\ServiceController::class, 'repairStatus'])->name('repair.status');
Route::get('/vacancy', \App\Http\Controllers\Open\Vacancy::class)->name('open.vacancy');
Route::get('/contacts', \App\Http\Controllers\Open\Contact::class)->name('open.contact');

Route::post('/login', [\App\Http\Controllers\RegController::class, 'postLogin'])->name('login.post');
Route::post('/remember/restore', [\App\Http\Controllers\RegController::class, 'restore'])->name('remember.restore');
Route::get('/registration', [\App\Http\Controllers\RegController::class, 'registration'])->name('register.index');
Route::post('/registration', [\App\Http\Controllers\RegController::class, 'register'])->name('register.store');


Route::group(['middleware' => ['check.role']], function () {
    Route::post('/email/manager', [\App\Http\Controllers\HomeController::class, 'emailFeedback'])->name('email.feedback');
    ...
    Route::get('/pages/repair-status', [\App\Http\Controllers\Open\ServiceController::class, 'repairStatus'])->name('pages.repair.status');
    ...
    Route::group(['prefix' => 'cart'], function () {
        ...
        Route::get('/service', [\App\Http\Controllers\CartController::class, 'service'])->name('cart.service');
        Route::post('/add-cart', [\App\Http\Controllers\CartController::class, 'addCart'])->name('cart.store');
        Route::get('/service/toggle', [\App\Http\Controllers\CartController::class, 'toggleService'])->name('cart.service.toggle');
    });
    ...
    Route::group(['prefix' => 'profile'], function () {
        ...
        Route::get('/repairs', [\App\Http\Controllers\ProfileController::class, 'repairs'])->name('profile.repairs');
        Route::get('/subscribes', [\App\Http\Controllers\ProfileController::class, 'subscribes'])->name('profile.subscribes');
...
Route::group(['prefix' => 'api/v2'], function() {
    ...
    Route::post('/sync/partners', 'Api_1c8\PartnerController@syncPartners');
    Route::post('/sync/employees', 'Api_1c8\UserController@syncEmployees');
